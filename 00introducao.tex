...
\lettrine{U}{m} número enorme de estudantes conclui seus estudos de física no ensino médio com a leve sensação de que tudo funciona quase como uma espécie de mágica. Tem-se uma quantidade enorme de fórmulas --- que sabe-se lá de onde vieram ou por que funcionam --- que devem ser memorizadas e, ao acertar qual é a fórmula correta a se usar em um certo contexto, jogam-se os valores, fazem-se algumas contas, e \textit{voilà}: a resposta sai ao final, como em um passe de mágica.

\pullquote{Tudo funciona quase\\como uma espécie de mágica.}
...
\lettrine{T}{alvez} o primeiro questionamento que devemos tentar responder seja:
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.09]{imagensintro/sol.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.16]{imagensintro/quedalivre.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.18]{imagensintro/colher.png}};
      \end{scope}
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.18]{imagensintro/carros.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.12]{imagensintro/coulomb.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.10]{imagensintro/socrates.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.10]{imagensintro/refracao.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.10]{imagensintro/pendulo.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.10]{imagensintro/onda.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.8\linewidth]{imagensintro/ondapropagando.png}};
  \end{scope}
\end{tikzpicture}
...
\lettrine{C}{omo} dito, essa é uma coleção que se dividirá em três volumes, sendo este --- o primeiro deles --- sobre Mecânica, e não poderia ser de outra forma.
