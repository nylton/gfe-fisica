...
\lettrine{N}{este} capítulo, estudaremos os movimentos mais simples que a natureza oferece: aqueles que ocorrem em uma única dimensão — ao longo de uma reta. Como discutimos na introdução desta parte, essa restrição nos permite tratar as grandezas cinemáticas de forma algébrica, sem recorrer ao formalismo vetorial: uma velocidade positiva indica que o corpo se move em um sentido; uma velocidade negativa, no sentido oposto. É esse artifício simples que justifica o nome Cinemática Escalar.
...
Ao longo da introdução, na seção \ref{subsecao_introducao_eqsdefinicoes}, já discutimos amplamente qual é a razão de criarmos o conceito de velocidade e defini-lo como fizemos, de modo que ficaria demasiadamente repetitivo trazer de novo tal discussão aqui. Dito isso, vale destacarmos uma pequena diferença entre a definição de velocidade média que lá fizemos e a que foi feita aqui, por meio da Equação \eqref{mecanica_eq_velocidademedia}. 
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.135]{imagensmecanica/deslocamentoescalar.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
Veja que a distância percorrida leva em conta, de fato, o comprimento da trajetória do corpo, enquanto que o deslocamento escalar -- posição final menos inicial -- irá medir o quanto o corpo se afastou do seu ponto de partida, ou seja, o efeito ``líquido do movimento''. Note que em todos os casos nos quais \textbf{não há inversão no sentido do movimento}, ou seja, o objeto sempre avança no mesmo sentido, a distância e o deslocamento escalar irão sempre coincidir -- e boa parte dos movimentos que estudaremos aqui estarão nesse contexto. Ou seja, nesses casos, as Equações \eqref{00intro_eq_velocidade} e \eqref{mecanica_eq_velocidademedia} serão equivalentes. O deslocamento escalar e a distância foram diferentes no caso da Figura \ref{fig_mec_deslocamento_vs_distancia02} justamente pelo fato de que o carro mudou o sentido de seu movimento.
 ...
 \begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.12]{imagensmecanica/deslocamentoescalarn.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{itemize}
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.15]{imagensmecanica/deslocamentovsdistanciaescalar.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.2\linewidth]{imagensmecanica/exemplovmedianivel2afa.png}};
  \end{scope}
\end{tikzpicture}
\captionof{figure}{}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.9\linewidth]{imagensmecanica/galileu_movimentoerepouso1.jpeg}};
  \end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=1.0\linewidth]{imagensmecanica/galileu_movimentoerepouso2.jpeg}};
  \end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.8\linewidth]{imagensmecanica/balancapratos01.jpeg}};
  \end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.8\linewidth]{imagensmecanica/balancapratos02.jpeg}};
  \end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.6\linewidth]{imagensmecanica/velrelativaemudancaderefAB1.jpeg}};
  \end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.6\linewidth]{imagensmecanica/velrelativaemudancaderefAB2.jpeg}};
  \end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.6\linewidth]{imagensmecanica/velrelativaemudancaderefAB3.jpeg}};
  \end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.6\linewidth]{imagensmecanica/velrelativaemudancaderefAB5.jpeg}};
  \end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.6\linewidth]{imagensmecanica/velrelativaemudancaderefAB4.jpeg}};
  \end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.6\linewidth]{imagensmecanica/vrelsentidooposto.png}};
  \end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.5\linewidth]{imagensmecanica/vrelsentidoigual.jpeg}};
  \end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.5\linewidth]{imagensmecanica/mudancareferencialexemplo01.jpeg}};
  \end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.50\linewidth]{imagensmecanica/ufmgboiarioexemplotest.png}};
  \end{scope}
\end{tikzpicture}
\captionof{figure}{}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=1.0\linewidth]{imagensmecanica/imagem_sem_fundo_2.png}};
  \end{scope}
\end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.18]{imagensmecanica/acelerecao01.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.18]{imagensmecanica/acelerecao02.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.12]{imagensmecanica/mu01.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.12]{imagensmecanica/mu02.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.6\linewidth]{imagensmecanica/muexemplo01.jpeg}};
  \end{scope}
\end{tikzpicture}
\captionof{figure}{}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.6\linewidth]{imagensmecanica/muexemplo0102.jpeg}};
  \end{scope}
\end{tikzpicture}
\captionof{figure}{}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.35\linewidth]{imagensmecanica/muexemplo03ita.png}};
  \end{scope}
\end{tikzpicture}
\captionof{figure}{}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.4\linewidth]{imagensmecanica/muexemplo03itaresolucao.jpeg}};
  \end{scope}
\end{tikzpicture}
\captionof{figure}{}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.12]{imagensmecanica/mudvsdeltas1.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.12]{imagensmecanica/mudvsdeltas12.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.6\linewidth]{imagensmecanica/sorveteexemplo011.jpeg}};
  \end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.6\linewidth]{imagensmecanica/sorveteexemplo012.jpeg}};
  \end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.6\linewidth]{imagensmecanica/sorveteexemplo013.jpeg}};
  \end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.6\linewidth]{imagensmecanica/funcaoposicaoexemplo011.jpeg}};
  \end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.6\linewidth]{imagensmecanica/funcaoposicaoexemplo012.jpeg}};
  \end{scope}
\end{tikzpicture}
...
\lettrine{T}{al} movimento é \textbf{definido}\footnote{Ou seja, estamos criando vocabulário: dando um nome específico a um tipo específico de movimento.} como sendo aquele no qual o \textbf{valor da aceleração do objeto é constante}. Ou seja, como mostra a Figura \ref{fig_mec_muv}, a velocidade irá variar de quantidades iguais em iguais intervalos de tempo. Em tal exemplo, para quaisquer intervalos de tempo que o leitor escolher, o valor da aceleração será sempre o mesmo. Façamos alguns cálculos, a fim de tornar isso claro. Considerando o intervalo de tempo de $0$s a $1$s, teríamos:
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.15]{imagensmecanica/muvexemplo.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.15]{imagensmecanica/muvcontraexemplo.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.12]{imagensmecanica/muvfuncaovelocidade02.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.12]{imagensmecanica/muvfuncaovelocidade01.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.12]{imagensmecanica/muvfuncaovelocidade04.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.12]{imagensmecanica/muvfuncaovelocidadesinal1.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.12]{imagensmecanica/muvfuncaovelocidadetabelasinais.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.5\linewidth]{imagensmecanica/muvfuncaovelocidade03.jpeg}};
  \end{scope}
\end{tikzpicture}
\captionof{figure}{Referencial orientado para esquerda com origem arbitrária.}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.09]{imagensmecanica/muvgraficovxt.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.18]{imagensmecanica/muvfuncaoposicaoexemplo.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.28]{imagensmecanica/graficosmuv.png}};
      \end{scope}
    \end{tikzpicture}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.25\linewidth]{imagensmecanica/funcaoposicaomuvITAexemplo.png}};
  \end{scope}
\end{tikzpicture}
\captionof{figure}{}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.12]{imagensmecanica/torricelli02.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.12]{imagensmecanica/torricelli01.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{tikzpicture}
  \begin{scope}[blend mode=multiply]
    \node {\includegraphics[width=0.5\linewidth]{imagensmecanica/torricelli03.jpeg}};
  \end{scope}
\end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.12]{imagensmecanica/muvtrapezio01.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.12]{imagensmecanica/muvtrapezio02.jpeg}};
      \end{scope}
    \end{tikzpicture}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
      \begin{scope}[blend mode=multiply]
        \node {\includegraphics[scale=0.12]{imagensmecanica/muvtrapezio03.jpeg}};
      \end{scope}
    \end{tikzpicture}
